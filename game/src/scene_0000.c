...
void scene_0000_enter  (struct scene * scene)
{
    ...
    button_new_game  = scene_get_button_from_index(scene, 0);
    button_load_game = scene_get_button_from_index(scene, 1);
    button_quit      = scene_get_button_from_index(scene, 2);
    button_options   = scene_get_button_from_index(scene, 3);
